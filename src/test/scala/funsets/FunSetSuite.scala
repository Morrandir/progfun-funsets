...
class FunSetSuite extends FunSuite {
  ...
  test("singletonSet(1) contains 1") {
    ...
    new TestSets {
       ...
       */
      assert(contains(s1, 1), "singletonSet(1) doesn't contain 1")
      assert(contains(s2, 2), "singletonSet(2) doesn't contain 2")
      assert(contains(s3, 3), "singletonSet(3) doesn't contain 3")
    }
  }
